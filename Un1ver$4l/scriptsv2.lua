...
SectionMovement:Toggle({
    Title = "Bunny Hop",
    Desc = "Auto lompat saat berlari (Support PC & Mobile)",
    Icon = "rabbit",
    Value = false,
    Callback = function(state)
...
SectionMovement:Slider({
    Title = "Run Speed Threshold",
    Desc = "Kecepatan minimum untuk bunny hop | Default: 16",
    Icon = "gauge",
    Step = 1,
...
-- Load emotes dari Vexro + tambahan manual
local FullEmoteList = {}
...
local function loadVexroEmotes()
        ...
        if type(data) == "table" then
            for _, v in ipairs(data) do
                if v.name and v.id then
                    table.insert(FullEmoteList, { Title = tostring(v.name), Id = tonumber(v.id) })
                elseif v.Name and v.Id then
                    table.insert(FullEmoteList, { Title = tostring(v.Name), Id = tonumber(v.Id) })
                elseif type(v) == "table" then
                    for name, id in pairs(v) do
                        if type(name) == "string" and (type(id) == "number" or type(id) == "string") then
                            table.insert(FullEmoteList, { Title = tostring(name), Id = tonumber(id) })
                        end
                    end
                end
            end
    ...
    if not ok then
        WindUI:Notify({ Title = "Emote", Content = "Gagal load Vexro emotes, pakai fallback.", Duration = 3, Icon = "alert-circle" })
        -- Fallback emote list
        local fallback = {
            { Title = "Floss Dance", Id = 5917459365 }, { Title = "Fancy Feet", Id = 3333432454 },
            { Title = "Fashion", Id = 3333331310 }, { Title = "Shuffle", Id = 4349242221 },
            { Title = "Hype Dance", Id = 3695333486 }, { Title = "Bodybuilder", Id = 3333387824 },
            { Title = "Celebrate", Id = 3338097973 }, { Title = "Happy", Id = 4841405708 },
            { Title = "Sad", Id = 4841407203 }, { Title = "Sleep", Id = 4686925579 },
            { Title = "Shy", Id = 3337978742 }, { Title = "Shrug", Id = 3334392772 },
            { Title = "Tilt", Id = 3334538554 }, { Title = "Salute", Id = 3333474484 },
            { Title = "Zombie", Id = 4210116953 }, { Title = "Robot", Id = 3338025566 },
            { Title = "Break Dance", Id = 5915648917 }, { Title = "Dolphin Dance", Id = 5918726674 },
            { Title = "Samba", Id = 6869766175 }, { Title = "Cha-Cha", Id = 6862001787 },
            { Title = "Air Guitar", Id = 3695300085 }, { Title = "Jumping Cheer", Id = 5895324424 },
            { Title = "Rock On", Id = 5915714366 }, { Title = "Top Rock", Id = 3361276673 },
            { Title = "Side to Side", Id = 3333136415 }, { Title = "Twirl", Id = 3334968680 },
            { Title = "Point", Id = 3344585679 }, { Title = "Haha", Id = 3337966527 },
            { Title = "Hello", Id = 3344650532 }, { Title = "Wave", Id = 3576686446 },
            { Title = "Dance", Id = 3576720708 }, { Title = "Laugh", Id = 3576777185 },
        }
...
LocalPlayer.CharacterAdded:Connect(function(char)
    ...
    -- Restart bunny hop loop setelah respawn
